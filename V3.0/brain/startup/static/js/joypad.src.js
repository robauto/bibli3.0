...
(function() {
  ...
  RB.joy = {
    ...
    networkFrame: function() {
      ...
      //t.coords[0] = 1;
      //t.coords[1] = -1;
      var stopped = (t.coords[0] == 0 && t.coords[1] == 0);
      // don't spam stop commands
      if (stopped && t.sentStopLastFrame) {
        //console.log("Returned");
        return;
      }
      if (t.prev_coords[0] == t.coords[0] && t.prev_coords[1] == t.coords[1]) {
        //console.log("Returned");
        return;
      }
      // send coords to server
      //console.log("X:" + t.coords[0]);
      //console.log("Y:" + t.coords[1]);
      ...
      t.prev_coords[0] = t.coords[0]
      t.prev_coords[1] = t.coords[1]
