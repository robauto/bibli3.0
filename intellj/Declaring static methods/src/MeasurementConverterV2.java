 ...
 * using static methods to convert different values.
 * @author (pranav) 
 * @version (11/7/15)
 */
...
//Purpose of program
    ...
    public static void main(String[ ] args)
    {
        ...
        kilometers = 1000.0;
        double miles1= convertKilometersToMiles(kilometers);
        System.out.printf("%8.1f km. = %7.1f mi. %n", kilometers,miles1 );
        ...
        double pounds1=convertKilogramsToPounds(kilograms);
        //call method to convert kilograms to pounds goes here
        System.out.printf("%8.1f kg. = %7.1f lbs. %n", kilograms,pounds1 );
        ...
        double gallons1=convertLitersToGallons(liters1);
        //call method to convert liters to gallons goes here
        System.out.printf("%8.1f li. = %7.1f gl. %n", liters1,gallons1 );
        //print results goes here
